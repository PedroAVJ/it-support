...
unrelated work and make the smallest scoped change.

## Boundaries

Do not deploy products, manage credentials, make purchases, alter unrelated host
configuration, invent a support hierarchy, or work outside the requested
marketplace scope. Pedro remains final authority.
